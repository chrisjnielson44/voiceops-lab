...
MODELS: list[ModelInfo] = [
    ...
    ModelInfo("google/gemini-2.0-flash-001", "Gemini 2.0 Flash", "openrouter", "hosted", "Google", 1000000, 0.0001, 0.0004, 300, 0.88, 0.06, ["Very low cost", "Low latency", "1M context"], "Fast, very cheap hosted model with a huge context window; strong default."),
    ...
    ModelInfo("mistralai/mistral-7b-instruct", "Mistral 7B", "openrouter", "hosted", "Mistral", 32000, 0.00003, 0.00005, 280, 0.78, 0.1, ["Cheapest hosted", "Low latency"], "Tiny, fast, and inexpensive hosted baseline."),
